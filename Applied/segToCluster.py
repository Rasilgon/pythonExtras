...
subList= np.asarray(grep('/home/trashtos/CleaningTiles/SegmentationFinal/tile_row29col8/tile_row29col8_stack_cubic_80_80_4', listVectors))

inImage=  "/home/trashtos/CleaningTiles/SegmentationFinal/tile_row29col8_CIR_cubic1.tif"
values = np.zeros([len(subList), 4], dtype=float)


listImage = np.asarray([inImage for i in range(len(subList))])
outFile = "/home/trashtos/CleaningTiles/SegmentationFinal/tile_row29col8.txt"

listPar = [ list(x) for x in zip(subList, listImage)]
